        ...
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-sm  mt-4 bg-dark navbar-dark flex-column flex-md-row">
                <ul class="navbar-nav flex-row d-md-flex ">
                    ...
                    <!-- Dropdown -->
                    <?php if (!isset($permissions_message) && empty($permissions_message)) { ?>
                        <li id="get_categories" class="nav-item dropdown">
                            <div class="col-md-12">
                                <select class="form-control search_category select_multiple" id="product_categories" name="category_parent">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="card">
                            ...
                            <input type="hidden" name="session_branch_id" id="session_branch_id" value="<?= $_SESSION['branch_id'] ?>" />
                            ...
                            <div class="row d-flex justify-content-center p-2 align-content-center" class="img-thumbnail" id="get_products">
                                ...
                                <?php
                                $products = fetch_details(['branch_id' => $_SESSION['branch_id']], 'products');
                                if (!empty($products)) {  ?>
                        ...
                        <div class="card">
                            <section class="container content-section mt-4">
                                <form id="pos_form" method="post" action='<?= base_url('admin/point_of_sale/place_order') ?>'>
                                    ...
                                    <div class="row cart-row mt-4 mb-3">
                                        <div class="col-md-6">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text" onclick="togglePassword('password', 'password-icon')" style="cursor: pointer;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action='' id="register_form">
                    ...
                    <input type="hidden" id="appli_name">
                    <div class="d-flex flex-wrap gap-3" id="product_detail">

                    </div>
                    <h5 class="pt-2" id="addon"> </h5>
                    <div class="d-flex flex-wrap addon-wrap" id="add_ons_check">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id="add_add_ons_button" name="add_add_ons_button" data-dismiss="modal" value="Save">Add</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
