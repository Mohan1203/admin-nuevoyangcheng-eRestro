            ...
            <form class="form-horizontal form-submit-event" action="<?= base_url('admin/setting/update_system_settings') ?>" method="POST" id="system_setting_form" enctype="multipart/form-data">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-12">
                                    <label class="text text-danger">
                                        ...
                                        <strong> Note: </strong> To calculate delivery charges based on the distance between the customer and the restaurant, you can use Google's Routes API, which requires a paid API key. However, if you wish to avoid using the paid key, you can disable the Routes API. Note that without this API, the distance calculation may be less accurate, potentially leading to discrepancies in delivery charges compared to the more precise results provided by the Routes API.
                                ...
                                <div class="form-group col-md-6">
                                    <label for="google_map_app_api_key"> Googel Map KEY (For Application) <small>Do not restrict this key in cloud console</small> <span class='text-danger text-xs'>*</span></label>
                                    <input type="text" class="form-control" name="google_map_app_api_key" value="<?= (isset($settings['google_map_app_api_key']) && defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['google_map_app_api_key']) - 3) . substr($settings['google_map_app_api_key'], -3) : $settings['google_map_app_api_key'] ?>" placeholder="Enter your Google Map App API KEY" />
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="distance_matrix_api"> Routes API</label>
                                    <div class="card-body">
                                        <input type="checkbox" id="distance_matrix_api" name="distance_matrix_api" id="distance_matrix_api" <?= (isset($settings['distance_matrix_api']) && $settings['distance_matrix_api'] == '1') ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                    </div>
                                </div>
                                <?php $hiddenStatus = (isset($settings['distance_matrix_api']) && $settings['distance_matrix_api']  == '1') ? '' : 'd-none' ?>
                                <div class="form-group col-md-6 distance_matrix_google_map_api <?= $hiddenStatus ?>" id="google_map_api_container">
                                    <label for="google_map_api_key"> Routes API KEY (For Calculating Delivery Charge) <span class='text-danger text-xs'>*</span></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- default branch settings start -->
                        <!-- <div class="card card-info">
                            <div class="card-body">
                                <h4>Default Branch Settings</h4>
                                <hr>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <lable class="text-red">Select default branch for admin app</lable>
                                        <select name="default_branch" class="form-control">
                                            ...
                                            <?php foreach ($branches as $row) { ?>
                                                <option value="<?= $row['id'] ?>" <?= (isset($settings['default_branch']) && $settings['default_branch'] == $row['id']) ? 'selected' : "" ?>><?= stripslashes($row['branch_name']) ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="tax"> Tax <small>You have to add Taxation from this menu <strong>Products -> Tax <a href="<?= base_url('admin/taxes/manage-taxes') ?>" target="_BLANK"><i class="fa fa-link"></i></a></strong> </small> </label><br>
                        ...
                        <div class="card card-info">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="is_rider_app_maintenance_mode_on"> Rider App Maintenance Mode</label>
                                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="customer_app_android_link">Customer app link for android</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="rider_app_android_link">Rider app link for android</label>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="customer_app_ios_link">Customer app link for ios</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="rider_app_ios_link">Rider app link for ios</label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="number" class="form-control" oninput="validateNumberInput(this)" name="refer_earn_bonus" value="<?= (isset($settings['refer_earn_bonus'])) ? $settings['refer_earn_bonus'] : '' ?>" placeholder='In amount or percentages' />
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="max_refer_earn_amount">Maximum Refer & Earn Amount (<?= $currency ?>)</label>
                                        <input type="number" class="form-control" oninput="validateNumberInput(this)" name="max_refer_earn_amount" value="<?= (isset($settings['max_refer_earn_amount'])) ? $settings['max_refer_earn_amount'] : '' ?>" placeholder='Maximum Refer & Earn Bonus Amount' />
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="refer_earn_bonus_times">Number of times Bonus to be given to the customer</label>
                                        <input type="number" class="form-control" oninput="validateNumberInput(this)" name="refer_earn_bonus_times" value="<?= (isset($settings['refer_earn_bonus_times'])) ? $settings['refer_earn_bonus_times'] : '' ?>" placeholder='No of times customer will get bonus' />
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        <label for="app_name">Settel payment <span class='text-danger text-xs'>*</span></label>
