    ...
    <section class="content">
        <div class="container-fluid">
            <form class="form-horizontal" action="<?= base_url('admin/product/add_product'); ?>" method="POST" enctype="multipart/form-data" id="save-product">
                ...
                <?php } ?>
                <input type="hidden" name="branch_id" value="<?= isset($_SESSION['branch_id']) ? $_SESSION['branch_id'] : "" ?>">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <?php } ?>
                                                <select class="search_category select_multiple" id="mySelect" name="product_category_id" data-placeholder=" Type to search and select Category">
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                $tax_per = isset($tax[0]['percentage']) ? ($tax[0]['percentage']) : "";
                                                $tax_name = isset($tax[0]['title']) ? ($tax[0]['title']) : 'NIL' ?>
                                                <div class="col-sm-12">
                                                    <?php if (has_permissions('read', 'tax')) { ?>
                                                        <input type="text" class="form-control" disabled value="<?= $tax_name . " (" . $tax_per . "%)"  ?>">
                                                    <?php } else { ?>
                                                        <input type="text" class="form-control" disabled value="<?= 'NIL' . " (" . 0 . "%)"  ?>">

                                                    <?php } ?>
                                                    <input type="hidden" name="pro_input_tax" class="form-control" value="<?= $settings['tax'] ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" min="0" id="calories" placeholder="Enter calories in cal unit" name="calories" value="<?= @$product_details[0]['calories'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="minimum_order_quantity" value="<?= (isset($product_details[0]['minimum_order_quantity'])) ? $product_details[0]['minimum_order_quantity'] : ''; ?>" placeholder='Minimum Order Quantity'>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="available_time" class="col-12 col-form-label">Product available time ?</label>
                                            <div class="col-12">
                                                <input type="checkbox" name="available_time" id="available_time" class="switch" <?= (isset($product_details[0]['available_time']) && $product_details[0]['available_time'] == '1') ? 'Checked' : ''; ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                            </div>
                                        </div>
                                        <div class="form-group <?= (isset($product_details[0]['available_time']) && $product_details[0]['available_time'] == 1) ? '' : 'collapse' ?>" id="product_timing">
                                            <label for="start_time" class="col-sm-2 col-form-label">Start Time <span class='text-danger text-sm'>*</span></label>
                                            <input type="time" id="product_start_time" name="product_start_time" value="<?= @$product_details[0]['start_time'] ?>">
                                            <label for="end_time" class="col-sm-2 col-form-label ">End Time <span class='text-danger text-sm'>*</span></label>
                                            <input type="time" id="product_end_time" name="product_end_time" value="<?= @$product_details[0]['end_time'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" class="form-control" id="add_on_price" placeholder="Add ON Price" name="price" min="1">
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label for="add_on_calories" class="col-sm-3 col-form-label">Calories </label>
                                                <div class="col-sm-12">
                                                    <input type="number" class="form-control" id="add_on_calories" placeholder="Add On Calories" name="add_on_calories" min="1">
                                                </div>
                                            </div>
                                            <!-- <div class="form-group ">
                                                <label for="allow_multiple_qty" class="col-12 col-form-label">Allow Multipe Qty ?</label>
                                                <div class="col-12">
                                                    <input type="checkbox" name="allow_multiple_qty" id="allow_multiple_qty" class="switch" <?= (isset($product_details[0]['allow_multiple_qty']) && $product_details[0]['allow_multiple_qty'] == '1') ? 'Checked' : ''; ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                                </div>
                                            </div> -->
                                            <div class="form-group ">
                                                <div class="col-sm-12">
                                            ...
                                            <table class='table-striped' id='add_ons_table' data-toggle="table" data-url="<?= base_url('admin/product/get_product_add_ons?product_id=' . $product_details[0]['id']) ?>" data-side-pagination="server" data-click-to-select="true" data-pagination="true" data-id-field="id" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true" data-toolbar="#toolbar" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="queryParams">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <!-- <th data-field="allow_multiple_qty" data-sortable="true">Allow Mutiple</th> -->
                                                    ...
                                                    <div class="row mt-4 col-md-12 ">
                                                        ...
                                                        <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                                    ...
                                                                    <div class="form-group collapse" id="stock_level">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group row variant-product-level-stock-management collapse">
                                                                                <div class="col col-xs-12">
                                                                                    <label class="control-label">Total Stock :</label>
                                                                                    <input type="number" min="1" name="total_stock_variant_type" id="total_stock_variant_type" class="col form-control variant-stock-mustfill-field">
                                                                                </div>
                                                                                <div class="col col-xs-12">
                                                                                    <label class="control-label">Stock Status :</label>
                                                                                    <select type="text" id="stock_status_variant_type" name="variant_status" class="col form-control variant-stock-mustfill-field">
                                                            ...
                                                            <div class="tab-pane fade" id="product-attributes" role="tabpanel" aria-labelledby="product-attributes-tab">
                                                                ...
                                                                <div id="attributes_process">
                                                                    <div class="form-group text-center row my-auto p-2 border rounded bg-gray-light col-md-12 no-attributes-added">
                                                                        <div class="col-md-12 text-center">No Product Attributes Were Added !</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane fade" id="product-variants" role="tabpanel" aria-labelledby="product-variants-tab">
