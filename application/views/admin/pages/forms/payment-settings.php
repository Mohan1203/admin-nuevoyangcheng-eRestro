                    ...
                    <div class="card card-info">
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/Payment_settings/update_payment_settings'); ?>" method="POST" id="payment_setting_form">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="paypal_client_id">Client Id <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paypal_client_id" value="<?= (isset($settings['paypal_mode'])) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paypal_client_id']) - 3) . substr($settings['paypal_client_id'], -3) : $settings['paypal_client_id'] ?>" placeholder="Paypal Client Id" />
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="paypal_secret_key">Secret Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paypal_secret_key" value="<?= (isset($settings['paypal_mode'])) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paypal_secret_key']) - 3) . substr($settings['paypal_secret_key'], -3) : $settings['paypal_secret_key'] ?>" placeholder="Paypal Serect Key" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="paypal_business_email">Paypal Business Email <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paypal_business_email" value="<?= (isset($settings['paypal_mode'])) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paypal_business_email']) - 3) . substr($settings['paypal_business_email'], -3) : $settings['paypal_business_email']  ?>" placeholder="Paypal Business Email" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="razorpay_key_id">Razorpay key ID <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="razorpay_key_id" value="<?= isset($settings['razorpay_key_id']) &&   (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['razorpay_key_id']) - 3) . substr($settings['razorpay_key_id'], -3) :  @$settings['razorpay_key_id'] ?>" placeholder="Razor Key ID" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="razorpay_secret_key">Secret Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="razorpay_secret_key" value="<?= isset($settings['razorpay_secret_key'])  && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['razorpay_secret_key']) - 3) . substr($settings['razorpay_secret_key'], -3) : @$settings['razorpay_secret_key'] ?>" placeholder="Razorpay Secret Key " />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="razorpay__webhook_url" value="<?= base_url("app/v1/api/razorpay_webhook"); ?>" disabled />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="refund_webhook_secret_key">Webhoook Secret Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="paystack_key_id">Paystack key ID <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paystack_key_id" value="<?= isset($settings['paystack_key_id']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paystack_key_id']) - 3) . substr($settings['paystack_key_id'], -3) : @$settings['paystack_key_id'] ?>" placeholder="Paystack Public Key" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="paystack_secret_key">Secret Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paystack_secret_key" value="<?= isset($settings['paystack_secret_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paystack_secret_key']) - 3) . substr($settings['paystack_secret_key'], -3) :  @$settings['paystack_secret_key'] ?>" placeholder="Paystack Secret Key " />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="stripe_publishable_key">Stripe Publishable Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="stripe_publishable_key" value="<?= isset($settings['stripe_publishable_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['stripe_publishable_key']) - 3) . substr($settings['stripe_publishable_key'], -3) : @$settings['stripe_publishable_key'] ?>" placeholder="Stripe Publishable Key" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="stripe_secret_key">Stripe Secret Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="stripe_secret_key" value="<?= isset($settings['stripe_secret_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['stripe_secret_key']) - 3) . substr($settings['stripe_secret_key'], -3) : @$settings['stripe_secret_key'] ?>" placeholder="Stripe Secret Key" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="stripe_webhook_secret_key">Stripe Webhook Secret Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="stripe_webhook_secret_key" value="<?= isset($settings['stripe_webhook_secret_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['stripe_webhook_secret_key']) - 3) . substr($settings['stripe_webhook_secret_key'], -3) : @$settings['stripe_webhook_secret_key'] ?>" placeholder="Stripe Webhook Secret Key" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="flutterwave_public_key">Flutterwave Public Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="flutterwave_public_key" value="<?= isset($settings['flutterwave_public_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['flutterwave_public_key']) - 3) . substr($settings['flutterwave_public_key'], -3) :  @$settings['flutterwave_public_key'] ?>" placeholder="Flutterwave Public Key" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="flutterwave_secret_key">Secret Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="flutterwave_secret_key" value="<?= isset($settings['flutterwave_secret_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paypal_business_email']) - 3) . substr($settings['paypal_business_email'], -3) : @$settings['flutterwave_secret_key'] ?>" placeholder="Flutterwave Secret Key " />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="flutterwave_encryption_key">Flutterwave Encryption key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="flutterwave_encryption_key" value="<?= isset($settings['flutterwave_encryption_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['flutterwave_encryption_key']) - 3) . substr($settings['flutterwave_encryption_key'], -3) : @$settings['flutterwave_encryption_key'] ?>" placeholder="Flutterwave Encryption Key " />
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="paytm_merchant_key">Paytm Merchant Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paytm_merchant_key" value="<?= isset($settings['paytm_merchant_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paytm_merchant_key']) - 3) . substr($settings['paytm_merchant_key'], -3) :  @$settings['paytm_merchant_key'] ?>" placeholder="Paytm Merchant Key" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="paytm_merchant_id">Paytm Merchant ID <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="paytm_merchant_id" value="<?= isset($settings['paytm_merchant_id']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paytm_merchant_id']) - 3) . substr($settings['paytm_merchant_id'], -3) : @$settings['paytm_merchant_id'] ?>" placeholder="Paytm Merchant ID" />
                                    </div>
                                </div>
                                <?php
                                ...
                                ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" class="form-control" name="paytm_industry_type_id" value="<?= isset($settings['paytm_industry_type_id']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['paytm_industry_type_id']) - 3) . substr($settings['paytm_industry_type_id'], -3) : @$settings['paytm_industry_type_id'] ?>" placeholder="Industry Type ID" />
                                        </div>
                                    </div>
                                <?php } else { ?>
                                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="midtrans_client_key">Midtrans Client Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="midtrans_client_key" value="<?= isset($settings['midtrans_client_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['midtrans_client_key']) - 3) . substr($settings['midtrans_client_key'], -3) : @$settings['midtrans_client_key'] ?>" placeholder="Midtrans Client Key" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="midtrans_merchant_id">Midtrans Merchant ID <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="midtrans_merchant_id" value="<?= isset($settings['midtrans_merchant_id']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['midtrans_merchant_id']) - 3) . substr($settings['midtrans_merchant_id'], -3) : @$settings['midtrans_merchant_id'] ?>" placeholder="Midtrans Merchant ID" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="midtrans_server_key">Midtrans Server Key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="midtrans_server_key" value="<?= isset($settings['midtrans_server_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['midtrans_server_key']) - 3) . substr($settings['midtrans_server_key'], -3) : @$settings['midtrans_server_key'] ?>" placeholder="Midtrans Server Key" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="phonepe_payment_method">Phonepe Payments <small>[ Enable / Disable ] </small></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <select name="phonepe_payment_mode" class="form-control" required>
                                            <option value="">Select Mode</option>
                                            <option value="SANDBOX" <?= (isset($settings['phonepe_payment_mode']) && $settings['phonepe_payment_mode'] == 'SANDBOX') ? 'selected' : '' ?>>Sandbox</option>
                                            <option value="PRODUCTION" <?= (isset($settings['phonepe_payment_mode']) && $settings['phonepe_payment_mode'] == 'PRODUCTION') ? 'selected' : '' ?>>Live</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_webhook_url" value="<?= base_url("app/v1/api/phonepe_webhook"); ?>" readonly />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="phonepe_appid">Appid <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_appid" value="<?= isset($settings['phonepe_appid']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['phonepe_appid']) - 3) . substr($settings['phonepe_appid'], -3) : @$settings['phonepe_appid'] ?>" placeholder="AppId" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="phonepe_marchant_id">Marchant ID <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_marchant_id" value="<?= isset($settings['phonepe_marchant_id']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['phonepe_marchant_id']) - 3) . substr($settings['phonepe_marchant_id'], -3) : @$settings['phonepe_marchant_id'] ?>" placeholder="Marchant ID" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="phonepe_salt_index">Salt index <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_salt_index" value="<?= @$settings['phonepe_salt_index'] ?>" placeholder="Salt index" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="phonepe_salt_key">Salt key <span class='text-danger text-sm'>*</span></label>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_salt_key" value="<?= isset($settings['phonepe_salt_key']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['phonepe_salt_key']) - 3) . substr($settings['phonepe_salt_key'], -3) : @$settings['phonepe_salt_key'] ?>" placeholder="Salt key" />
                                    </div>
                                </div>
                                <!-- phonepe end -->
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-info" id="submit_btn">Update Payment Settings</button>
                                </div>
                            </div>
