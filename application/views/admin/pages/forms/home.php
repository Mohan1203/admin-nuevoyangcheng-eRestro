            ...
            <div class="row">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <a href="<?= base_url('admin/orders/') ?>"
                                class="text-info">Más información <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <p>Nuevos clientes</p>
                            <a href="<?= base_url('admin/customer/') ?>" class="text-info">Más información
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <a href="<?= base_url('admin/riders/manage-rider') ?>"
                                class="text-info">Más información <i
                ...
                <div class="col-xl-6 col-12" id="ecommerceChartView">
                    <div class="card card-shadow chart-height">
                        <div class="m-3">Análisis de ventas</div>
                        <div class="card-header card-header-transparent py-20 border-0">
                            <ul class="nav nav-pills nav-pills-rounded chart-action float-right btn-group" role="group">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                        href="#scoreLineToDay">Dia</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                        href="#scoreLineToWeek">Semana</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                        href="#scoreLineToMonth">Mes</a></li>
                            </ul>
                        </div>
                ...
                <div class="col-xl-6 col-12">
                    ...
                    <div class="card ">
                        <h3 class="card-title m-3">Recuento de productos por categoría</h3>
                        <div class="card-body">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="alert alert-dismissible products_stock_background">
                        ...
                        <a href="<?= base_url('admin/product/?flag=sold') ?>"
                            class="text-decoration-none small-box-footer">Más información <i
