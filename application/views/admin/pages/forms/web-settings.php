                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="numberInput" oninput="validateNumberInput(this)" class="form-control" name="support_number" value="<?= (isset($web_settings['support_number'])) ? output_escaping($web_settings['support_number']) : '' ?>" placeholder="Customer support mobile number" />
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="light_logo">Light Logo <span class='text-danger text-xs'>*</span></label>
                                                <div class="col-sm-10">
                                                    <div class='col-md-3'><a class="uploadFile img btn btn-primary text-white btn-sm" data-input='light_logo' data-isremovable='0' data-is-multiple-uploads-allowed='0' data-toggle="modal" data-target="#media-upload-modal" value="Upload Photo"><i class='fa fa-upload'></i> Upload</a></div>
                                                    <?php
                                                    if (!empty($light_logo)) {
                                                    ?>
                                                        <label class="text-danger mt-3">*Only Choose When Update is necessary</label>
                                                        <div class="container-fluid row image-upload-section">
                                                            <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image">
                                                                <div class=''>
                                                                    <div class='upload-media-div'><img class="img-fluid mb-2" src="<?= BASE_URL() . $light_logo ?>" alt="Image Not Found"></div>
                                                                    <input type="hidden" name="light_logo" id='light_logo' value='<?= $light_logo ?>'>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="landing_page_main_image">Landing page main image <span class='text-danger text-xs'>*</span></label>
                                                <div class="col-sm-10">
                                                    <div class='col-md-3'><a class="uploadFile img btn btn-primary text-white btn-sm" data-input='landing_page_main_image' data-isremovable='0' data-is-multiple-uploads-allowed='0' data-toggle="modal" data-target="#media-upload-modal" value="Upload Photo"><i class='fa fa-upload'></i> Upload</a></div>
                                                    <?php
                                                    if (!empty($landing_page_main_image)) {
                                                    ?>
                                                        <label class="text-danger mt-3">*Only Choose When Update is necessary</label>
                                                        <div class="container-fluid row image-upload-section">
                                                            <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image">
                                                                <img class="img-fluid mb-2" src="<?= BASE_URL() . $landing_page_main_image ?>" alt="Image Not Found">
                                                                <input type="hidden" name="landing_page_main_image" id='landing_page_main_image' value='<?= $landing_page_main_image ?>'>
                                                            </div>
                                                        </div>
                                                    <?php
                                                    } else { ?>
                                    ...
                                    <!-- landing page fields -->
                                    <div class="form-group col-md-12">
                                        <label for="landing_page_main_title">Landing Page Main Tile <span class='text-danger text-xs'>*</span></label>
                                        <input name="landing_page_main_title" id="landing_page_main_title" class="form-control" value="<?= (isset($web_settings['landing_page_main_title'])) ? $web_settings['landing_page_main_title'] : '' ?>" />
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="landing_page_description">Landing Page Description<span class='text-danger text-xs'>*</span></label>
                                        <textarea name="landing_page_description" id="landing_page_description" class="form-control" cols="30" rows="5"><?= (isset($web_settings['landing_page_description'])) ? $web_settings['landing_page_description'] : '' ?></textarea>
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="story_section_tile">Story Section Tile <span class='text-danger text-xs'>*</span></label>
                                        <input name="story_section_tile" id="story_section_tile" class="form-control" value="<?= (isset($web_settings['story_section_tile'])) ? $web_settings['story_section_tile'] : '' ?>" />
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="story_section_description">Story Section Description<span class='text-danger text-xs'>*</span></label>
                                        <textarea name="story_section_description" id="story_section_description" class="form-control" cols="30" rows="5"><?= (isset($web_settings['story_section_description'])) ? $web_settings['story_section_description'] : '' ?></textarea>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="tagline">Tagline<span class='text-danger text-xs'>*</span></label>
                                        <input type="text" class="form-control" name="tagline" value="<?= (isset($web_settings['tagline'])) ? output_escaping($web_settings['tagline']) : '' ?>" placeholder="Tagline" />
                                    </div>
                                </div>
                                <hr>
