...
$map_url = "https://maps.googleapis.com/maps/api/js?key=$javascript_map_key&libraries=places&v=beta"
    ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="min_order_amount_for_free_delivery"
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="bordering_city_ids[]" id="bordering_city_ids"
                                        class="search_city form-control" multiple onload="multiselect()">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            <ol>
                                ...
                                <li>Related Deliverable Cities: Hre you have to set related city which are nearby
                                ...
                                <li>By adding this <strong> Related Deliverable Cities</strong> All partners which are
