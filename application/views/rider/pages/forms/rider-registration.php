                            ...
                            <form class="form-horizontal form-submit-event" action="<?= base_url('admin/riders/add_rider'); ?>" method="POST" id="add_product_form">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" onclick="togglePassword('confirm_password', 'confirm-password-icon')" style="cursor: pointer;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="serviceable_city_list col-sm-10 w-10px">
                                            <select name="serviceable_city[]" id="serviceable_cities" class="serviceable_cities search_city w-100" multiple>
                                    ...
                                    <div class="form-group row">
                                        <label for="profile" class="col-sm-3 col-form-label">Rider Profile</label>
                                        <div class="col-sm-10">
