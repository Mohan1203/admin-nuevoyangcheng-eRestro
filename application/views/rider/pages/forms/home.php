                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        ...
                                        <?php if ($commission_method == "percentage_on_delivery_charges") { ?>
                                            <div class="media-body text-right">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="media-body text-right">
                                                <h5 class="text-muted text-bold-500">Commission</h5>
                                                <h3 class="text-bold-600"><?= $curreny . ' ' . $commission ?></h3>
                                            </div>
                ...
                <div class="col-md-12 main-content">
                    <div class="card content-area p-4">
                        <div class="card-innr">
                            ...
                            <table class='table-striped orders-table' data-toggle="table" data-url="<?= base_url('rider/orders/view_orders') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel","csv"]' data-export-options='{
