                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-submit-event" action="<?= base_url('rider/login/update_user') ?>" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Accept Orders <span class='text-danger text-sm'>*</span></label>
                                    <div id="status" class="btn-group col-sm-8">
                                        <label class="btn btn-default" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                                            <input type="radio" name="status" value="0" <?= (isset($users->accept_orders) && $users->accept_orders == '0') ? 'Checked' : '' ?>> Deactive
                                        </label>
                                        <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                            <input type="radio" name="status" value="1" <?= (isset($users->accept_orders) && $users->accept_orders == '1') ? 'Checked' : '' ?>> Active
                                        </label>
                                    </div>
                                </div>
